...
const questions = [
  ...
  'Which employee do you want to view the employees by manager?'
];
  ...
  constructor() {}
    ...
    async getEmployeesByManager() {
      ...
      pool.query(sql, (err, result) => {
        ...
        // ])
        // .then(choices => {
        //   const managers = employees.filter(employee => employee.value !== choices.listEmployees);
        //   inquirer.prompt([
        //     {
        //       type: 'list',
        //       name: 'managerEmployees',
        ...
        //   ])
        //   .then(managerChoice => {
        //     const params = [choices.listEmployees, managerChoice.managerEmployees];
